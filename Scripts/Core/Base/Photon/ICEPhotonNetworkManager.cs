...
namespace ICE.Integration.Adapter
{
	...
	public class ICEPhotonNetworkManager : Photon.PunBehaviour 
	{
		#region Objects
...
*/
		...
		{
			if( m_Instance == null )
				m_Instance = this as ICEWorldNetworkManager;
		...
		protected virtual void OnEnable()
		{
			...
			ICEWorldInfo.IsServer = PhotonNetwork.isMasterClient;
		...
		public override void OnJoinedRoom()
		{
			...
			if( ! PhotonNetwork.automaticallySyncScene || PhotonNetwork.room.PlayerCount == 1 )
				LoadScene();
		}
		...
		protected virtual void UpdateConnectionState()
		{
			...
			if( ICEWorldInfo.IsServer != PhotonNetwork.isMasterClient )
			{
