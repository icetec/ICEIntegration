...
{
	#if ICE_PUN
	[CustomEditor(typeof(ICEPhotonNetworkView))]
	public class ICEPhotonNetworkViewEditor : ICEWorldBehaviourEditor {
		...
		public void DrawPhotonAdapterContent( ICEWorldNetworkView _adapter )
		{
